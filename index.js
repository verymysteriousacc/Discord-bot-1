...
function pedro(text) {
  ...
  if (t.includes("come")) {
    return `pedro.exe:me want you come | ${text}`;
  }
  ...
  if (t.includes("bruh")) {
    return `pedro.exe: wat ever 😒😒😒😒 | ${text}`;
  }

  if (t.includes("1v1") || t.includes("fight")) {
    return `pedro.exe: game 1v1 😒 | ${text}`;
  }

  if (t.includes("corrupt") || t.includes("transform") || t.includes("error") || t.includes("glitch")) {
